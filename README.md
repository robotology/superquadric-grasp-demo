...
<img src="https://github.com/robotology/superquadric-grasp-demo/blob/master/misc/pipeline.png" width=850 height=500>
...
1. A median filter computes a model by averaging all the reconstructed superquadrics. This approach leads to more stable and robust models.
...
Here is a video of the running pipeline:[<img src="https://github.com/robotology/superquadric-grasp/blob/master/misc/new-video-grasp.png" width=1000>](https://www.youtube.com/watch?v=dfYdBQ-mBJQ&feature=youtu.be)[`Go to the top`](#superquadric-grasp-demo)

More information are available in [these slides](https://github.com/robotology/superquadric-grasp-demo/blob/master/misc/superquadric-grasp-slides.pdf).
## Use case
...
[`Go to the top`](#superquadric-grasp-demo)
...
1. Launch and connect all the modules required from the demo, which are collected in the  [`iCub_Grasp_Demo` xml](https://github.com/robotology/superquadric-grasp-demo/blob/master/app/script/superquadric-grasp-demo.xml.template).
1. The [`rfsmGui`](https://github.com/robotology/rfsmTools#testing-the-rfsmgui) will open. Play `run` on the Gui to start  the state machine executing the demo. More information about the `Superquadric_Grasp_Demo` state machine are provided [here](https://github.com/robotology/superquadric-grasp-demo/tree/master/app/lua).
...
<img src="https://github.com/robotology/superquadric-grasp-demo/blob/master/misc/pipeline-visual.png" width=650 height=400>
...
## Documentation
The online documentation of this module is available [here](http://robotology.github.com/superquadric-grasp-demo).
